...
2. After copying over the contents, go ahead and import the example qvf found [here](..assets/Churn%20Predictions.qvf?raw=true) or the example qvw (if using QlikView) [here](../assets/DPI%20-%20Python%20Churn%20Predictions.qvw?raw=true).
